...
`;
	...
	describe("GitHub to Slack markdown conversion with code", () => {
		...
		it.skip("should convert mid-line triple backticks to inline code", () => {
			...
			const md =
				"This code block ```* list _item_``` is actually inline code\n";
			const expected =
				"This code block `* list _item_` is actually inline code\n";
			assert(githubToSlack(md) === expected);
		});
	...
	describe("Just GitHub to Slack markdown conversion", () => {
		...
		it("given simple image link should leave URL", () => {
			assert.strictEqual(
				githubToSlack('<img  width="345" src="http://someplace.com">'),
				"http://someplace.com",
			);
		});
		...
		it("given image link with other attributes should leave URL", () => {
			assert.strictEqual(
				githubToSlack(
					'<img  width="345" src="http://someplace.com" alt="screen shot">',
				),
				"http://someplace.com",
			);
		});
		...
		it("given encoded image link should leave URL", () => {
			assert.strictEqual(
				githubToSlack(
					'&lt;img  width="345" src="http://someplace.com"&gt;',
				),
				"http://someplace.com",
			);
		});
		...
		it("given link will convert it", () => {
			assert.strictEqual(
				githubToSlack("[click here](http://someplace.com)"),
